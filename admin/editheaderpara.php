...
$qry = mysqli_query($db,"select * from headerpara where id='$id'"); // select query
...
if(isset($_POST['submit'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update headerpara set content='$content' where id='$id'");
    
    if($edit)
    {
        mysqli_close($db); // Close connection
        header("location:../admin/headerimg.php"); // redirects to all records page
        exit;
    }
    else
    {
