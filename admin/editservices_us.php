...
$qry = mysqli_query($db,"select * from services_us where id='$id'"); // select query
...
if(isset($_POST['submit'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update services_us set content='$content' where id='$id'");
    
    if($edit)
    {
        mysqli_close($db); // Close connection
        header("location:services_us.php"); // redirects to all records page
        exit;
    }
    else
    {
