...
$qry = mysqli_query($db,"select * from content2 where id='$id'"); // select query
...
if(isset($_POST['submit'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update content2 set content='$content' where id='$id'");
    
    if($edit)
    {
        mysqli_close($db); // Close connection
        header("location:content1.php"); // redirects to all records page
        exit;
    }
    else
    {
