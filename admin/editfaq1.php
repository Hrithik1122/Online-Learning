...
$qry = mysqli_query($db,"select * from faq1 where id='$id'"); // select query
...
if(isset($_POST['submit'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update faq1 set content='$content' where id='$id'");
    
    if($edit)
    {
        mysqli_close($db); // Close connection
        header("location:../admin/faq.php"); // redirects to all records page
        exit;
    }
    else
    {
