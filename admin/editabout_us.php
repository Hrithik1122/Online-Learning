...
$qry = mysqli_query($db,"select * from about_us where id='$id'"); // select query
...
if(isset($_POST['submit'])) // when click on Update button
{
    ...
    $edit = mysqli_query($db,"update about_us set content='$content' where id='$id'");
    
    if($edit)
    {
        mysqli_close($db); // Close connection
        header("location:about_us.php"); // redirects to all records page
        exit;
    }
    else
    {
