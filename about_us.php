...
if (isset($_REQUEST["submit"])) 
{
  ...
  $sql = "INSERT INTO about_us(content) value('$content')";
...
<h2 align="center" style="color: white; background-color:  #000099; font-family:Comic sans MS;" >About Us Content</h2>
...
$records = mysqli_query($db,"select * from about_us"); // fetch data from database
...
<td>
  <a href="editabout_us.php?id=<?php echo $data['id']; ?>">Edit</a></td>
<?php
}
?>
</table>
